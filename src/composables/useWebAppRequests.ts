...
import type { OnContactRequestedCallback, OnWriteAccessRequestedCallback } from '~/types'
...
export function useWebAppRequests() {
  ...
  const onWriteAccessRequested = (eventHandler: OnWriteAccessRequestedCallback) =>
