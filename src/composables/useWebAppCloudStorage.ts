...
type SetItemResult = Parameters<NonNullable<NonNullable<Parameters<typeof CloudStorage.setItem>>[2]>>[1]
...
type GetItemResult = Parameters<NonNullable<NonNullable<Parameters<typeof CloudStorage.getItem>>[1]>>[1]
...
type GetItemsResult = NonNullable<Parameters<NonNullable<NonNullable<Parameters<typeof CloudStorage.getItems>>[1]>>[1]>
...
type RemoveItemResult = Parameters<NonNullable<NonNullable<Parameters<typeof CloudStorage.removeItem>>[1]>>[1]
...
type RemoveItemsResult = Parameters<NonNullable<NonNullable<Parameters<typeof CloudStorage.removeItems>>[1]>>[1]
...
type GetKeysResult = NonNullable<Parameters<NonNullable<NonNullable<Parameters<typeof CloudStorage.getKeys>>[0]>>[1]>
