...
export const useAccelerometer = () => _useAccelerometer('6.1')
export const useBackButton = () => _useBackButton('6.1')
export const useBiometricManager = () => _useBiometricManager('6.1')
export const useClipboard = () => _useClipboard('6.1')
export const useCloudStorage = () => _useCloudStorage('6.1')
export const useDeviceOrientation = () => _useDeviceOrientation('6.1')
export const useDeviceStorage = () => _useDeviceStorage('6.1')
export const useEmojiStatus = () => _useEmojiStatus('6.1')
export const useGyroscope = () => _useGyroscope('6.1')
export const useHapticFeedback = () => _useHapticFeedback('6.1')
export const useHomeScreen = () => _useHomeScreen('6.1')
export const useLocationManager = () => _useLocationManager('6.1')
export const useMainButton = () => _useMainButton('6.1')
export const useMiniApp = () => _useMiniApp('6.1')
export const usePopup = () => _usePopup('6.1')
export const useQrScanner = () => _useQrScanner('6.1')
export const useSecondaryButton = () => _useSecondaryButton('6.1')
export const useSecureStorage = () => _useSecureStorage('6.1')
export const useSettingsButton = () => _useSettingsButton('6.1')
export const useTheme = () => _useTheme('6.1')
export const useViewport = () => _useViewport('6.1')
