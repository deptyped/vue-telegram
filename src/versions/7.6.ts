...
export const useAccelerometer = () => _useAccelerometer('7.6')
export const useBackButton = () => _useBackButton('7.6')
export const useBiometricManager = () => _useBiometricManager('7.6')
export const useClipboard = () => _useClipboard('7.6')
export const useCloudStorage = () => _useCloudStorage('7.6')
export const useDeviceOrientation = () => _useDeviceOrientation('7.6')
export const useDeviceStorage = () => _useDeviceStorage('7.6')
export const useEmojiStatus = () => _useEmojiStatus('7.6')
export const useGyroscope = () => _useGyroscope('7.6')
export const useHapticFeedback = () => _useHapticFeedback('7.6')
export const useHomeScreen = () => _useHomeScreen('7.6')
export const useLocationManager = () => _useLocationManager('7.6')
export const useMainButton = () => _useMainButton('7.6')
export const useMiniApp = () => _useMiniApp('7.6')
export const usePopup = () => _usePopup('7.6')
export const useQrScanner = () => _useQrScanner('7.6')
export const useSecondaryButton = () => _useSecondaryButton('7.6')
export const useSecureStorage = () => _useSecureStorage('7.6')
export const useSettingsButton = () => _useSettingsButton('7.6')
export const useTheme = () => _useTheme('7.6')
export const useViewport = () => _useViewport('7.6')
