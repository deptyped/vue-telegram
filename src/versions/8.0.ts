...
export const useAccelerometer = () => _useAccelerometer('8.0')
export const useBackButton = () => _useBackButton('8.0')
export const useBiometricManager = () => _useBiometricManager('8.0')
export const useClipboard = () => _useClipboard('8.0')
export const useCloudStorage = () => _useCloudStorage('8.0')
export const useDeviceOrientation = () => _useDeviceOrientation('8.0')
export const useDeviceStorage = () => _useDeviceStorage('8.0')
export const useEmojiStatus = () => _useEmojiStatus('8.0')
export const useGyroscope = () => _useGyroscope('8.0')
export const useHapticFeedback = () => _useHapticFeedback('8.0')
export const useHomeScreen = () => _useHomeScreen('8.0')
export const useLocationManager = () => _useLocationManager('8.0')
export const useMainButton = () => _useMainButton('8.0')
export const useMiniApp = () => _useMiniApp('8.0')
export const usePopup = () => _usePopup('8.0')
export const useQrScanner = () => _useQrScanner('8.0')
export const useSecondaryButton = () => _useSecondaryButton('8.0')
export const useSecureStorage = () => _useSecureStorage('8.0')
export const useSettingsButton = () => _useSettingsButton('8.0')
export const useTheme = () => _useTheme('8.0')
export const useViewport = () => _useViewport('8.0')
