...
export const useAccelerometer = () => _useAccelerometer('9.0')
export const useBackButton = () => _useBackButton('9.0')
export const useBiometricManager = () => _useBiometricManager('9.0')
export const useClipboard = () => _useClipboard('9.0')
export const useCloudStorage = () => _useCloudStorage('9.0')
export const useDeviceOrientation = () => _useDeviceOrientation('9.0')
export const useDeviceStorage = () => _useDeviceStorage('9.0')
export const useEmojiStatus = () => _useEmojiStatus('9.0')
export const useGyroscope = () => _useGyroscope('9.0')
export const useHapticFeedback = () => _useHapticFeedback('9.0')
export const useHomeScreen = () => _useHomeScreen('9.0')
export const useLocationManager = () => _useLocationManager('9.0')
export const useMainButton = () => _useMainButton('9.0')
export const useMiniApp = () => _useMiniApp('9.0')
export const usePopup = () => _usePopup('9.0')
export const useQrScanner = () => _useQrScanner('9.0')
export const useSecondaryButton = () => _useSecondaryButton('9.0')
export const useSecureStorage = () => _useSecureStorage('9.0')
export const useSettingsButton = () => _useSettingsButton('9.0')
export const useTheme = () => _useTheme('9.0')
export const useViewport = () => _useViewport('9.0')
