...
export type OnViewportChangedCallback = (eventData: { isStateStable: boolean }) => void
...
export type OnInvoiceClosedCallback = (eventData: { url: string; status: 'paid' | 'cancelled' | 'failed' | 'pending' }) => void
